...
class GetFriendsListRequest :
 ...
 public:
  ...
  // uint32 useid = 1;
  void clear_useid();
  ::PROTOBUF_NAMESPACE_ID::uint32 useid() const;
  void set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_useid() const;
  void _internal_set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::uint32 useid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_friend_2eproto;
};
// -------------------------------------------------------------------
...
// uint32 useid = 1;
inline void GetFriendsListRequest::clear_useid() {
  useid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListRequest::_internal_useid() const {
  return useid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListRequest::useid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequest.useid)
  return _internal_useid();
}
inline void GetFriendsListRequest::_internal_set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  useid_ = value;
}
inline void GetFriendsListRequest::set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_useid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListRequest.useid)
}
